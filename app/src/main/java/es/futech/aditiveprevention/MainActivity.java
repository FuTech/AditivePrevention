...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_scann) {
            ...
            Intent showProduct = new Intent(this, ShowProduct.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(result != null) {
            if(result.getContents() == null) {
                ...
                String barcodeResult = result.getContents().toString();
                Intent showProduct = new Intent(this, ShowProduct.class);


                //Toast.makeText(this, "Scanned: " + barcodeResult, Toast.LENGTH_LONG).show();

                showProduct.putExtra("BARCODE", barcodeResult);
                startActivity(showProduct);
